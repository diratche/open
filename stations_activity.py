...
for message in consumer:
    ...
    try:
        available_bikes = station_status_dic[station['name']]['bikes']
        available_stands = station_status_dic[station['name']]['stands']
        if station['totalStands']['availabilities']['bikes'] != available_bikes or station['totalStands']['availabilities']['stands'] != available_stands:
            station_status_dic[station['name']] = {'bikes': station['totalStands']['availabilities']['bikes'], 'stands': station['totalStands']['availabilities']['stands']}
        ...
        station_status_dic[station['name']] = {'bikes': available_bikes, 'stands': available_stands}
        producer.send(topic_out, station)
